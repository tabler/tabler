import iconsInfoConfig from '@/data/icons-info.json';
...
export const iconsVersion = iconsInfoConfig.version
...
export const iconsCountRounded = (() => {
  return Math.floor(iconsInfoConfig.count / 50) * 50
})()

export const iconsCount = (() => {
  return iconsInfoConfig.count
})()
...
export const componentsUrl =
  process.env.NODE_ENV === 'development' ? 'http://components.tabler.test:3000' : 'https://components.tabler.io'
