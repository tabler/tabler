      ...
      <Container>
        <div className="row items-center xl:g-6">
          <div className="md:col-6 md:text-left" data-aos="fade-up">
            ...
            <p className="hero-description mt-4">{iconsCount} free, open source icons designed to make your website or app attractive, visually consistent and simply beautiful.</p>
          ...
          <div className="md:col-6 md:order-first" data-aos="fade-up">
            <div className="hero-img-side">
              <Slider
                ...
                slides={[
                  <ResponsiveImage src="/img/icons/hero-1.png" className="mx-auto" width="552" height="420" alt="" key="hero-1" />,
                  <ResponsiveImage src="/img/icons/hero-2.png" className="mx-auto" width="552" height="420" alt="" key="hero-2" />,
                  <ResponsiveImage src="/img/icons/hero-3.png" className="mx-auto" width="552" height="420" alt="" key="hero-3" />,
                  <ResponsiveImage src="/img/icons/hero-4.png" className="mx-auto" width="552" height="420" alt="" key="hero-4" />,
                  <ResponsiveImage src="/img/icons/hero-5.png" className="mx-auto" width="552" height="420" alt="" key="hero-5" />,
                ]}
              />
            </div>
          </div>
