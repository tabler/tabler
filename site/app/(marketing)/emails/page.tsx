      ...
      <Container>
        <div className="row xl:g-7">
          <div className="lg:col-6">
            <ResponsiveImage src="/img/tabler-emails/features/emails.png" width="564" height="549" className="mx-auto" />
          </div>
                ...
                <div className="row">
                  ...
                  <div className="col">
                    ...
                    <p className="text-muted m-0">
                      Prepare engaging email campaigns and newsletters, keep your recipients up to date with the latest news, let them know about their order status or send out customer satisfaction surveys. Our set of emails will help you
              ...
              <div data-aos="fade-up" data-aos-delay="150">
                <div className="row">
                  ...
                  <div className="col">
                    ...
                    <p className="text-muted m-0">
                      Customize the templates to make them suitable for your target group. You can change every element as you wish, including the background, colors, icons, spacers and images. And if you want to present your data in an
                      attractive way, make use of advanced reports, charts or progress bars.
                    </p>
                  </div>
                </div>
              </div>
              <div data-aos="fade-up" data-aos-delay="300">
                <div className="row">
                  ...
                  <div className="col">
                    ...
                    <p className="text-muted m-0">
                      More than 50% of emails today are open on mobile devices, so we’ve made sure our templates look great on any device and screen size. They are fully responsive and mobile-ready, helping you take care of great user
                      experience.
                    </p>
                  </div>
                </div>
    ...
    <section className="section">
      <Container>
        <div className="row xl:g-7">
          <div className="lg:col-6 d-flex flex-column items-center">
            <div className="section-header w-100">
              <h4 className="section-title text-center lg:text-left">Focus on your brand and we’ll take care of the rest</h4>
            </div>
            <div className="space-y-5">
              <div data-aos="fade-up" data-aos-delay="0">
                <div className="row">
                  ...
                  <div className="col">
                    ...
                    <p className="text-muted m-0">
                      Based on Bootstrap and Material Design principles, our email templates are responsive and meet the highest quality standards. Thanks to that, you can be sure the layout will look perfect in every email client and on
                      any device.
                    </p>
                  </div>
                </div>
              ...
              <div data-aos="fade-up" data-aos-delay="150">
                <div className="row">
                  ...
                  <div className="col">
                    ...
                    <p className="text-muted m-0">
                      Our templates are ready-to-use. You don’t need coding skills to prepare eye-catching emails and boost your brand awareness. Have a basic knowledge of HTML? Design your own email using the elements from different
                      templates and make it even more customized.
                    </p>
                  </div>
                </div>
              </div>
    ...
    <section className="section section-dark">
      <Container>
        <div className="row xl:g-7 items-center">
          <div className="lg:col-6">
            <ResponsiveImage src="/img/tabler-emails/features/dark.png" width="564" height="585" key="img-1" className="mx-auto" />
          </div>
          <div className="lg:col-6">
            <div className="section-header text-left">
              ...
              <div className="section-description">
                <p>
                  Dark mode is a darker color palette for low-light or nighttime environments. This inverted color scheme uses light typography, UI elements and icons on a dark background - and is one of the hottest trends in digital design
                  in recent years. If your subscribers are making a conscious decision to view Dark Mode emails, it&apos;s best to respect that!
                </p>
                <p>Each email in Tabler Emails is available in two color versions: light and dark. It&apos;s up to you which version suits your branding better!</p>
              </div>
            </div>
          </div>
        </div>
