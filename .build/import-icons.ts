#!/usr/bin/env node
// Regenerates shared/data/icons.json and icons-info.json from the installed
// @tabler/icons package. `pnpm run update:icons` bumps the package first.
//
// Run: pnpm run import:icons
