        ...
        <div class="my-3 my-md-5">
          <div class="container">
            ...
            <div class="row row-cards row-deck">
                ...
                <div class="card">
                  <div class="card-body d-flex flex-column">
                    ...
                    <div class="d-flex align-items-center pt-5 mt-auto">
                      ...
                      <div>
                        <a href="./profile.html" class="text-default">Craig Anderson</a>
                        <small class="d-block text-muted">3 days ago</small>
                      </div>
                      <div class="ml-auto text-muted">
                        <a href="javascript:void(0)" class="icon d-none d-md-inline-block ml-3"><i class="fe fe-heart mr-1"></i></a>
              ...
              <div class="col-lg-6">
                <div class="card card-aside">
                  <a href="#" class="card-aside-column w-50" style="background-image: url(./demo/photos/grant-ritchie-338179-500.jpg)"></a>
                  <div class="card-body d-flex flex-column">
                    <h4><a href="#">Weaseling out of things is important to learn.</a></h4>
