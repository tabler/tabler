...
Symfony-specific note: include generated Encore assets in your base Twig template: `{% raw %}{{ encore_entry_link_tags("app") }}{% endraw %}` and `{% raw %}{{ encore_entry_script_tags("app") }}{% endraw %}`.
