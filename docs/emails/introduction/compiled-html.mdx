...
The `compiled.html` file with the `assets/` folder can be sent to your email marketing tool, like Mailchimp, SendGrid, or any other.

#### Mailchimp example

1. Zip the `compiled.html` file and the `assets/` folder of the selected email template.
2. Log in to your Mailchimp account.
3. Go to the Campaigns tab and click to add a new campaign.
4. Select the Email option form the right side and set the name of campaign.
5. Select the group of recipients and an email address from which the email should be sent.
6. Define the subject of the email.
7. When asked about the template choose the "code your own" option and upload the zip created in the 1st step.