...
If you want to make more advanced changes to the email template, you can use the source HTML files - `source.html`. They are ready to use, but you need a bit more knowledge of HTML to modify them.
...
4. Use a selected tool to inline the CSS styles into the HTML file.
