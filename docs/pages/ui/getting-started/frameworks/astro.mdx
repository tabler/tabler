...
description: Install `@tabler/core`, import CSS and client-side JS in Astro, and render a minimal page layout with a Tabler card.
...
Use this guide to integrate Tabler in an Astro site.
