...
Add an avatar and a `.page-subtitle` block with meta information to introduce a profile page. Icons and links in the subtitle give users quick context about the person or item.
