...
<Example vertical centered separated height={500}>
...
<Example vertical centered separated height={400}>
<div class="card">
  <div class="card-body">
...
<Example centered columns={1} height={500}>
<div class="card">
  <div class="img-responsive img-responsive-16x9 card-img-top" style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1670871139297-a0fa99ec523d?auto=format&fit=crop&w=400&q=80)'}}></div>
  <div class="card-body">
...
<Example centered columns={1} height={600}>
<div class="card d-flex flex-column">
  <a href="#">
    <img class="card-img-top" src="https://images.unsplash.com/photo-1670700420923-ef68d8612f23?auto=format&fit=crop&w=300&q=80" alt="How do you know she is a witch?" />
  </a>
  <div class="card-body d-flex flex-column">
    ...
    <div class="d-flex align-items-center pt-4 mt-auto">
      <span class="avatar" style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1563240619-44ec0047592c?q=80&fm=jpg&crop=faces&fit=crop&h=100&w=100)'}}></span>
      <div class="ms-3">
...
<Example columns={2} centered height={400}>
<div class="card d-flex flex-column">
  <div class="row row-0 flex-fill">
    <div class="col-md-3">
      <a href="#">
        <img src="https://images.unsplash.com/photo-1672957581665-bdc4a16b8347?auto=format&fit=crop&w=687&q=80" class="w-100 h-100 object-cover" alt="Card side image" />
      </a>
    </div>
    <div class="col">
      <div class="card-body">
        ...
        <div class="d-flex align-items-center pt-4 mt-auto">
          <span class="avatar" style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1511424187101-2aaa60069357?q=80&fm=jpg&crop=faces&fit=crop&h=100&w=100)'}}></span>
          <div class="ms-3">
...
<Example columns={1} centered height={300}>
