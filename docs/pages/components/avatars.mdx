...
<Example>
<span class="avatar"><!-- SVG icon from http://tabler-icons.io/i/user -->
...
<span class="avatar"><!-- SVG icon from http://tabler-icons.io/i/plus -->
...
<span class="avatar"><!-- SVG icon from http://tabler-icons.io/i/user-plus -->
