...
(function () {
    ...
    var global$6 = hugerte.util.Tools.resolve('hugerte.PluginManager');
    ...
    var global$5 = hugerte.util.Tools.resolve('hugerte.util.Tools');

    var global$4 = hugerte.util.Tools.resolve('hugerte.dom.DOMUtils');

    var global$3 = hugerte.util.Tools.resolve('hugerte.html.DomParser');
    ...
    var global$2 = hugerte.util.Tools.resolve('hugerte.html.Node');

    var global$1 = hugerte.util.Tools.resolve('hugerte.html.Serializer');
