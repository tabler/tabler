...
(function () {
    ...
    var global$7 = hugerte.util.Tools.resolve('hugerte.PluginManager');
    ...
    var global$6 = hugerte.util.Tools.resolve('hugerte.dom.RangeUtils');

    var global$5 = hugerte.util.Tools.resolve('hugerte.dom.TreeWalker');

    var global$4 = hugerte.util.Tools.resolve('hugerte.util.VK');
    ...
    var global$3 = hugerte.util.Tools.resolve('hugerte.dom.DOMUtils');

    var global$2 = hugerte.util.Tools.resolve('hugerte.util.Tools');
    ...
    var global$1 = hugerte.util.Tools.resolve('hugerte.dom.BookmarkManager');
    ...
    var global = hugerte.util.Tools.resolve('hugerte.html.Node');
