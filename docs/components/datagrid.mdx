  ...
  <div class="datagrid-item">
    ...
    <div class="datagrid-content">
      <div class="d-flex align-items-center">
        <span class="avatar avatar-xs me-2 rounded" stylexxx="background-image: url(...)"></span>
        Paweł Kuna
      </div>
    </div>
  </div>
  ...
  <div class="datagrid-item">
    ...
    <div class="datagrid-content">
      <div class="avatar-list avatar-list-stacked">
        <span class="avatar avatar-xs rounded" stylexxx="background-image: url(...)"></span>
...
<div class="datagrid">
  ...
  <div class="datagrid-item">
    ...
    <div class="datagrid-content">
      <div class="avatar-list avatar-list-stacked">
        <span class="avatar avatar-xs rounded" style="background-image: url(...)"></span>
        <span class="avatar avatar-xs rounded">JL</span>
        <span class="avatar avatar-xs rounded" style="background-image: url(...)"></span>
        <span class="avatar avatar-xs rounded" style="background-image: url(...)"></span>
        <span class="avatar avatar-xs rounded" style="background-image: url(...)"></span>
