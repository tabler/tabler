...
import coverLight from '../../images/cover-payments.jpg'
import coverDark from '../../images/cover-payments-dark.jpg'

<figure>
	<Image src={coverLight} alt="Tabler Payments" class="hide-theme-dark" width={800} densities={[1, 2]} loading="eager" />
	<Image src={coverDark} alt="Tabler Payments" class="hide-theme-light" width={800} densities={[1, 2]} loading="eager" />
</figure>
