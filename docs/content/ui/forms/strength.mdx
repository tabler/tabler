...
<div class="strength mt-2" data-bs-strength aria-label="Password strength">
  <span class="strength-segment"></span>
  <span class="strength-segment"></span>
  <span class="strength-segment"></span>
  <span class="strength-segment"></span>
</div>
<div class="strength-text mt-1"></div>
</Example>
...
- Keep the field's own requirements in a `form-hint` under it. A meter says how strong the password is, not which rules a form enforces.
