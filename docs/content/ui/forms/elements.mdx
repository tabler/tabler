...
order: 1
related: [/ui/forms/validation, /ui/forms/helpers, /ui/forms/fieldset, /ui/forms/date-picker, /ui/forms/advanced-select]
---
...
Add a [range slider](/ui/components/range-slider) to make it possible for users to set a value or range, such as a price range or a time frame.
