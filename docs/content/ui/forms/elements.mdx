...
Add a [range input](/ui/forms/range) to make it possible for users to set a value or range, such as a price range or a time frame.

<Example column>
<div class="mb-3">
  <label class="form-label">Range input</label>
  <input type="range" class="form-range" value="40" min="0" max="100" step="10" data-bs-toggle="range" />
</div>
</Example>
