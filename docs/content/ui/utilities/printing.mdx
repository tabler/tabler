...
If you build your own layout elements and want them hidden on print too, add the [`.print:d-none`](#print-utilities) utility class, or use the [`media-print` mixin](#the-media-print-mixin) in your own SCSS.
...
-|-
`print:d-none`|`none`
`print:d-inline`|`inline`
`print:d-inline-block`|`inline-block`
`print:d-block`|`block`
`print:d-grid`|`grid`
`print:d-inline-grid`|`inline-grid`
`print:d-table`|`table`
`print:d-table-row`|`table-row`
`print:d-table-cell`|`table-cell`
`print:d-flex`|`flex`
`print:d-inline-flex`|`inline-flex`

`.print:d-none` is the one you'll use most - add it to anything that shouldn't appear on a printout, like a "Search" box or an "Edit" button:

<Example>
<div class="print:d-none"><span class="badge bg-blue-lt">Hidden on print</span></div>
</Example>
...
```html
<div class="d-none print:d-block">This text only shows up when the page is printed.</div>
```
