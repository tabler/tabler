...
<Example>
<div class="page">
  <header class="navbar sm:navbar-expand print:d-none">
    <div class="xl:container">
      <h1 class="navbar-brand navbar-brand-autodark pe-0 md:pe-3">
        <a href="#">
          <img src="/static/logo.svg" width="110" height="32" alt="Tabler" class="navbar-brand-image" />
        </a>
      </h1>
      <div class="navbar-nav flex-row md:order-last">
        <div class="nav-item">
...
Add a `footer` element with the `footer` class after `.page-wrapper` to close the page. `print:d-none` hides it when the page is printed, the same as the navbar. Use [`list-inline list-inline-dots`](/ui/components/list-group#inline-list) for the footer links.

<Example>
<footer class="footer footer-transparent print:d-none">
  <div class="xl:container">
    <div class="row text-center align-items-center flex-row-reverse">
      <div class="lg:col-auto lg:ms-auto">
      ...
      <div class="col-12 lg:col-auto mt-3 lg:mt-0">
        <ul class="list-inline list-inline-dots mb-0">
...
<Example>
<div class="page">
  <aside class="navbar navbar-vertical sm:navbar-expand position-absolute">
...
```html
<aside class="navbar navbar-vertical lg:navbar-expand">
  <div class="container-fluid">
...
<div class="page">
  <aside class="navbar navbar-vertical sm:navbar-expand navbar-folded position-absolute">
    <div class="container-fluid">
...
```html
<aside class="navbar navbar-vertical lg:navbar-expand navbar-folded-hover">...</aside>
```
...
Beyond the sidebar, six more layout choices are available as attributes on `<html>`, applied before the page renders by [`tabler-theme.js`](/ui/getting-started/color-modes). Every one of them has a static route too, so you can hard-code a layout without any JavaScript.
...
`data-bs-navbar-style="floating"` keeps a gap between the navigation and the edges around it, and gives it a border and rounded corners:

```html
<html data-bs-navbar-style="floating">
```

The attribute covers whichever navigation the page shows. The sidebar keeps its width, and the page next to it moves over by the same gap. On the two-row navbar both rows float. The navigation floats only from its `navbar-expand-*` breakpoint up. Without the attribute, add the [`navbar-floating`](/ui/layout/navbars#floating-navbar) class to a navbar in your markup:

```html
<header class="navbar md:navbar-expand navbar-floating">...</header>
```

### Floating offcanvas

`data-bs-offcanvas-style="floating"` does the same for every [offcanvas](/ui/components/offcanvas#floating-panel) on the page:

```html
<html data-bs-offcanvas-style="floating">
```

Without the attribute, add the `offcanvas-floating` class to a single panel.
...
```html
<div class="page">
  <aside class="navbar navbar-vertical lg:navbar-expand">...</aside>
  <header class="navbar md:navbar-expand">...</header>
...
```html
<header class="navbar md:navbar-expand" data-bs-theme="dark">...</header>
<header class="navbar md:navbar-expand bg-primary" data-bs-theme="dark">...</header>
```
...
- `print:d-none` on the navbar and the footer removes them from print, which is what you want - but check that nothing users need only exists there.
