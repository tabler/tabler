  ...
  <div class="row align-items-center">
    ...
    <div class="col-auto ms-auto">
      <div class="btn-list">
        ...
        <a href="#" class="btn btn-primary d-none d-sm-inline-block"> <Icon name="plus" /> Create new report </a>
    ...
    <div class="row align-items-center">
      ...
      <div class="col-auto">
        <div class="btn-list">
          ...
          <a href="#" class="btn d-none d-md-inline-flex"> <Icon name="bell" /> Subscribe </a>
        </div>
      </div>
    </div>
  </div>
