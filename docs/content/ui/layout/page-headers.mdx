---
title: Page headers
summary: Page header layouts with a title, a pretitle, breadcrumbs, meta information and action buttons.
...
<div class="page-header">
  <div class="row align-items-center">
    ...
    <div class="col-auto ms-auto">
      <div class="btn-list">
        <span class="d-none sm:d-inline"><a href="#" class="btn">New view</a></span>
        <a href="#" class="btn btn-primary d-none sm:d-inline-block"> <Icon name="plus" /> Create new report </a>
        <a href="#" class="btn btn-primary sm:d-none btn-icon" aria-label="Create new report">
          <Icon name="plus" />
        </a>
      </div>
    </div>
    ...
    <div class="col">
      ...
      <div class="page-subtitle">
        <div class="row">
          ...
          <div class="col-auto text-success"><Icon name="check" /> Verified</div>
        </div>
      </div>
    </div>
    <div class="col-auto d-none md:d-flex">
...
<div class="page-header">
  <div class="row align-items-center">
    ...
    <div class="col-auto ms-auto d-print-none">
      <div class="d-flex">
        <div class="me-3 d-none md:d-block">
          <div class="input-icon">
            <input type="search" class="form-control" placeholder="Search…" aria-label="Search" />
            <span class="input-icon-addon"><Icon name="search" /></span>
          </div>
        </div>
        <a href="#" class="btn btn-primary"> <Icon name="plus" /> Add photo </a>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="row align-items-center">
      ...
      <div class="col-auto">
        <div class="btn-list">
          ...
          <a href="#" class="btn d-none md:d-inline-flex"> <Icon name="bell" /> Subscribe </a>
        </div>
      </div>
    </div>
  </div>
...
<div class="page-header">
  <div class="row align-items-center mw-100">
    ...
    <div class="col-auto">
      <div class="btn-list">
        <a href="#" class="btn d-none md:d-inline-flex">
          <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"> <path stroke="none" d="M0 0h24v24H0z" fill="none" /> <path d="M7 7h-1a2 2 0 0 0 -2 2v9a2 2 0 0 0 2 2h9a2 2 0 0 0 2 -2v-1" /> <path d="M20.385 6.585a2.1 2.1 0 0 0 -2.97 -2.97l-8.415 8.385v3h3l8.385 -8.415z" /> <path d="M16 5l3 3" /> </svg> Edit
        </a>
...
Use `.page-section-title` to split a long page body into sections, for example between groups of cards in a `.row-cards` grid. Add a `.page-section-description` below it to say in one sentence what the section holds.

<Example>
<div class="row row-cards">
  <div class="col-12">
    <h2 class="page-section-title">Line charts</h2>
    <p class="page-section-description">Trends over time, where the change between points matters more than single values.</p>
  </div>
  <div class="col-md-6">
    <div class="card">
      <div class="card-body">
        <h3 class="card-title">Revenue by plan</h3>
        <p class="text-secondary mb-0">Monthly revenue of each plan.</p>
      </div>
    </div>
  </div>
  <div class="col-md-6">
    <div class="card">
      <div class="card-body">
        ...
        <p class="text-secondary mb-0">Load of web servers and workers in one day.</p>
      </div>
    </div>
  </div>
</div>
...
The title sets its own size and top margin, so it looks the same on an `h2`, an `h3` or a `div`. The space below comes from the grid gutter.

## Accessibility

- The page title belongs in an `h1`, and there should be exactly one per page. `page-title` is a style, not a heading.
- A section title is a real heading. Use an `h2` under the page `h1`, and an `h3` for card titles inside that section.
