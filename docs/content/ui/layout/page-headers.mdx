    ...
    <div class="col">
      ...
      <div class="page-subtitle">
        <div class="row">
          ...
          <div class="col-auto">
            <Icon name="users" /> <a href="#" class="text-reset">194 friends</a>
          </div>
...
<div class="page-header">
  <div class="row align-items-center mw-100">
    <div class="col">
      ...
      <h2 class="page-title">
        <span class="text-truncate">Knights of Ni, we are but simple travelers who seek the enchanter who lives beyond these
          woods.</span>
      </h2>
    </div>
    <div class="col-auto">
