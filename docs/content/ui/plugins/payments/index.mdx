...
If your project uses React, Vue, Preact, or Astro, you can use payment provider logos as components instead of CSS classes. Each provider ships as its own tree-shakable component (for example `PaymentVisa`), plus a `Payment` component that renders by slug — useful for a data-driven list of accepted methods.

- [React](/ui/plugins/payments/react)
- [Vue](/ui/plugins/payments/vue)
- [Preact](/ui/plugins/payments/preact)
- [Astro](/ui/plugins/payments/astro)
