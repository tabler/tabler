...
title: Color picker
order: 9
summary: A color picker lets users pick a color from a gradient, a set of swatches or a typed value, for theme settings and tag colors.
...
Write the swatches as hex values. Tabler's CSS variables such as `--tblr-blue` hold `oklch()` colors, which Coloris cannot parse, so do not read the swatches from them.
...
<div class="card">
  <div class="card-body">
    <div class="mb-0">
      ...
      <div class="form-text">This color is used for buttons and links.</div>
    </div>
  </div>
</div>
</Example>
...
window.addEventListener('load', function () {
	...
	const swatches = ['#066fd1', '#4299e1', '#4263eb', '#ae3ec9', '#d6336c', '#d63939', '#f76707', '#2fb344'];
