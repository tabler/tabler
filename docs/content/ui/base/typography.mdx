---
title: Typography
summary: How Tabler styles headings, paragraphs, semantic text elements, horizontal rules and the text utilities.
description: How Tabler styles headings, paragraphs and text elements to keep content readable.
