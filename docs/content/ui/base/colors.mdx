---
title: Colors
summary: The Tabler color palette, with the base colors, their light variants, the gray scale and the brand colors of social networks, each with background and text utilities.
