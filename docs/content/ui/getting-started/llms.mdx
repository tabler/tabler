...
The examples come from the documentation source. Most of them are written as plain html and appear in the markdown exactly as they render on the page.

A small number of examples are written with Tabler's own documentation components. Those show up as component tags, for example `<Alert type="success" />`, instead of the final markup. Open the html page for those.
