...
<Example centered>
<button type="button" class="btn btn-outline-primary" data-bs-toggle="confetti" data-bs-count="60" data-bs-duration="800">A few</button>
<button type="button" class="btn btn-outline-primary" data-bs-toggle="confetti" data-bs-count="600" data-bs-duration="6000">A lot</button>
</Example>
