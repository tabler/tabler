...
source: core/scss/ui/_lists.scss
classnames:
  component:
    - class: list-group
  ...
  part:
    ...
    - class: list-group-item-actions
      desc: Slot for controls on the trailing edge of an entry
  style:
    - class: list-group-flush
      desc: Removes the outer border, to sit flush in a card
    - class: list-group-transparent
      desc: Removes the background and the borders
    - class: list-group-numbered
      desc: Numbers the entries
    - class: list-separated
      desc: Spaces the entries apart instead of joining them with borders
  behavior:
    - class: list-group-hoverable
      desc: Highlights the entry under the cursor
    - class: list-group-item-action
      desc: Marks an entry as a link or a button
  direction:
    - class: list-group-horizontal
      desc: Lays the entries out in a row; prefixed variants only above that width
  color:
    - class: list-group-item-{color}
      desc: Tints one entry, for example list-group-item-success
---
...
<div class="list-group list-group-hoverable">
  <div class="list-group-item">
    <div class="row align-items-center">
      ...
      <div class="col-auto">
        <a href="#" class="list-group-item-actions" aria-label="Add to favorites"><Icon name="star" color="secondary" /></a>
      </div>
    </div>
  </div>
  <div class="list-group-item">
    <div class="row align-items-center">
      ...
      <div class="col-auto">
        <a href="#" class="list-group-item-actions show" aria-label="Remove from favorites"><Icon name="star" color="yellow" /></a>
      </div>
    </div>
  </div>
</div>
...
<div class="list-group list-group-transparent">
  <a href="#" class="list-group-item list-group-item-action d-flex align-items-center"> <Icon name="user" class="me-2" /> Account </a>
  <a href="#" class="list-group-item list-group-item-action d-flex align-items-center active"> <Icon name="settings" class="me-2" /> Settings </a>
  <a href="#" class="list-group-item list-group-item-action d-flex align-items-center"> <Icon name="bell" class="me-2" /> Notifications </a>
</div>
</Example>
...
Add `list-group-horizontal` to place the items in a row. Use a breakpoint, for example `md:list-group-horizontal`, to switch from a column to a row on wider screens.
