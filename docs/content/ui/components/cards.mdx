...
{%- endcapture %}
{% include "example.html" html=html bg="surface-secondary" %}
...
{%- endcapture %}
{% include "example.html" html=html bg="surface-secondary" column vertical %}
...
{%- endcapture %}
{% include "example.html" html=html bg="surface-secondary" column %}
