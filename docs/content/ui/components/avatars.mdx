...
{% capture html -%}
<span class="avatar" style="background-image: url(/avatars/002f.jpg)"></span>
<span class="avatar">JL</span>
{%- endcapture %}
{% include "example.html" html=html vertical %}

```html example centered separated code
<span class="avatar" style="background-image: url(/avatars/002f.jpg)"></span>
<span class="avatar">JL</span>
<span class="avatar" style="background-image: url(/avatars/004f.jpg)"></span>
```
...
{% capture html -%}
<span class="avatar" style="background-image: url(/avatars/016f.jpg)"></span>
<span class="avatar" style="background-image: url(/avatars/022m.jpg)"></span>
<span class="avatar" style="background-image: url(/avatars/036m.jpg)"></span>
{%- endcapture %}
...
```html example centered separated code
<span class="avatar avatar-xl" style="background-image: url(/avatars/000m.jpg)"></span>
<span class="avatar avatar-lg" style="background-image: url(/avatars/000m.jpg)"></span>
<span class="avatar avatar-md" style="background-image: url(/avatars/000m.jpg)"></span>
...
<span class="avatar avatar-xs" style="background-image: url(/avatars/000m.jpg)"></span>
```
...
```html example centered separated code
<span class="avatar" style="background-image: url(/avatars/018m.jpg)"></span>
<span class="avatar" style="background-image: url(/avatars/015m.jpg)">
  <span class="badge bg-danger"></span>
</span>
<span class="avatar" style="background-image: url(/avatars/022m.jpg)">
...
<span class="avatar" style="background-image: url(/avatars/048m.jpg)">
...
```html example centered separated
<span class="avatar" style="background-image: url(/avatars/019m.jpg)"></span>
<span class="avatar rounded" style="background-image: url(/avatars/039f.jpg)"></span>
<span class="avatar rounded-circle">AA</span>
<span class="avatar rounded-0" style="background-image: url(/avatars/043f.jpg)"></span>
<span class="avatar rounded-3" style="background-image: url(/avatars/044f.jpg)"></span>
```
...
<div class="avatar-list">
  <span class="avatar rounded" style="background-image: url(/avatars/031f.jpg)"></span>
  <span class="avatar rounded">JL</span>
  <span class="avatar rounded" style="background-image: url(/avatars/033f.jpg)"></span>
  <span class="avatar rounded" style="background-image: url(/avatars/017m.jpg)"></span>
  <span class="avatar rounded" style="background-image: url(/avatars/024m.jpg)"></span>
</div>
```
...
<div class="avatar-list avatar-list-stacked">
  ...
  <span class="avatar" style="background-image: url(/avatars/026m.jpg)"></span>
  <span class="avatar" style="background-image: url(/avatars/016f.jpg)"></span>
  <span class="avatar" style="background-image: url(/avatars/028m.jpg)"></span>
  <span class="avatar" style="background-image: url(/avatars/030m.jpg)"></span>
...
<div class="avatar-list avatar-list-stacked">
  <span
    ...
    style="background-image: url(/avatars/035m.jpg)"
  ></span>
  <span
    class="avatar avatar-sm rounded-circle"
    style="background-image: url(/avatars/027f.jpg)"
  ></span>
  <span
    class="avatar avatar-sm rounded-circle"
    style="background-image: url(/avatars/036f.jpg)"
  ></span>
  <span class="avatar avatar-sm rounded-circle">SA</span>
  <span
    class="avatar avatar-sm rounded-circle"
    style="background-image: url(/avatars/034f.jpg)"
  ></span>
  <span
    class="avatar avatar-sm rounded-circle"
    style="background-image: url(/avatars/043f.jpg)"
  ></span>
  <span
    class="avatar avatar-sm rounded-circle"
    style="background-image: url(/avatars/039f.jpg)"
  ></span>
  <span
    class="avatar avatar-sm rounded-circle"
    style="background-image: url(/avatars/020m.jpg)"
  ></span>
</div>
```
