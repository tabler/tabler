---
title: Alert
summary: Alerts report the result of an action or a problem to fix, in success, info, warning and danger variants, with icons, links and a dismiss button.
...
Put the icon in an `alert-icon` wrapper as the first child of the alert, and the heading and text in a second element next to it. The alert lays its children out in a row, so no extra flex wrapper is needed.
...
<div class="alert alert-info" role="alert">
  <div class="alert-icon">
    <Icon name="info-circle" class="alert-icon" />
  </div>
  <div>
...
<div class="alert alert-warning" role="alert">
  <div class="alert-icon">
    <Icon name="alert-triangle" class="alert-icon" />
  </div>
  <div>
...
<div class="alert alert-success alert-dismissible" role="alert">
  <h3 class="alert-heading">Some Title</h3>
...
- Color alone does not say "error". A red alert and a green one must differ in their words too.
