---
title: Alert
summary: Alerts tell the user about the result of an action or a problem to fix. They come in success, info, warning and danger variants, with icons, links, buttons and a dismiss control.
