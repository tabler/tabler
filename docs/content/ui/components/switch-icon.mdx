...
<button type="button" class="switch-icon switch-icon-scale" data-bs-toggle="switch-icon" aria-pressed="false" aria-label="Add to favourites">
...
- Colour alone should not carry the state. A filled red heart and an outlined grey one differ in shape too, which is what makes them readable.
