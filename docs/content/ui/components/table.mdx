...
A wide table can stack into a list instead of scrolling sideways. Use `.table-mobile-{breakpoint}` - `.md:table-mobile` stacks below `md` - and give every cell a `data-label`, which becomes the label above its value.
