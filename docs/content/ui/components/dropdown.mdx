...
Use dropdowns with [checkboxes](/ui/forms/form-elements) to allow users to select options from a predefined list. Dropdowns with checkboxes are particularly useful for filtering.
