...
<div class="card">
  <div class="card-body">
    ...
    <div class="mb-3">
      ...
      <div class="signature position-relative">
        <div class="position-absolute top-0 end-0 p-2">
          <button type="button" class="btn btn-icon" id="signature-form-clear" title="Clear signature"><Icon name="trash" /></button>
        </div>
    ...
    <div class="mt-4 d-flex"><button type="button" class="btn">Cancel</button> <button type="button" class="btn btn-primary ms-auto">Confirm transfer</button></div>
  </div>
</div>
</Example>
