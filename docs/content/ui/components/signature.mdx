    ...
    <div class="mb-3">
      ...
      <div class="signature position-relative">
        ...
        <canvas
          ...
          width="400"
          height="180"
          style="height: 9rem"></canvas>
      </div>
    </div>
    <div class="text-secondary fs-5">
      I agree that this signature is the electronic representation of my signature for all purposes
      when I use it on documents.
    </div>
