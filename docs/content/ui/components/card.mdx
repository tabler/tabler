---
title: Card
summary: A card groups related content in one box, with an optional header, footer, image and actions, and it's the building block of most Tabler pages.
...
<div class="card d-flex flex-column">
  ...
  <div class="card-body d-flex flex-column">
    ...
    <div class="d-flex align-items-center pt-4 mt-auto">
      ...
      <div class="ms-auto">
        <a href="#" class="icon d-none md:d-inline-block ms-3 text-secondary" aria-label="Like">
          <Icon name="heart" />
        </a>
      </div>
    </div>
    ...
    <div class="col">
      <div class="card-body h-full d-flex flex-column">
        ...
        <div class="d-flex align-items-center pt-4 mt-auto">
          ...
          <div class="ms-auto">
            <a href="#" class="icon d-none md:d-inline-block ms-3 text-red" aria-label="Unlike">
              <Icon name="heart" />
            </a>
          </div>
        </div>
...
Wrap several cards in `.card-tabs` and put a `.nav-tabs` list above them to switch between them with [tabs](/ui/components/tab). Only one card is visible at a time, so it's a way to fit more content into the same space.
...
<div class="card">
  <div class="card-header">
    ...
    <div class="card-actions">
      <a href="#" class="btn btn-primary"> <Icon name="plus" /> Invite </a>
    </div>
  </div>
...
<div class="row row-deck">
  ...
  <div class="md:col-4">
    <div class="card card-transparent">
      <div class="card-body text-secondary"><Icon name="plus" /> Add new</div>
    </div>
  </div>
</div>
</Example>
