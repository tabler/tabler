...
source: core/scss/ui/_chat.scss
classnames:
  component:
    - class: chat
  ...
  part:
    - class: chat-bubbles
      desc: Wrapper around a group of messages from one author
    - class: chat-bubble
      desc: A single message
    - class: chat-bubble-title
      desc: Header line of a message, holding the author and the time
    - class: chat-bubble-author
      desc: Author name
  ...
  style:
    - class: chat-bubble-me
      desc: Marks the message as sent by the current user
---
