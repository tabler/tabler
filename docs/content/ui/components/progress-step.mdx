...
summary: Progress steps show where the user is in a short flow such as setup or onboarding, with done, active and upcoming steps.
...
css-vars: progress-steps
classnames:
  component:
    - class: progress-steps
      desc: Container element
  part:
    - class: progress-steps-item
      desc: One step; mark the reached ones as active
---
