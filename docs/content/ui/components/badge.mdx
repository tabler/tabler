---
title: Badge
summary: A badge is a small label for a count, a status or a tag. It comes in colors, light styles, pills, dots and notification badges.
description: Add badges to show counts, labels, or statuses. Use colors, pill styles, links, and notification dots to add context.
