...
describe('Sortable', () => {
  ...
  describe('constructor', () => {
    ...
    it('should keep the SortableJS default for the drag image', () => {
      new Sortable(list())

      expect(plugin.mock.calls[0][1]).not.toHaveProperty('forceFallback')
    })

    it('should let data-sortable turn the styled copy on', () => {
      fixtureEl.innerHTML = '<ul data-sortable=\'{"forceFallback":true}\'><li>a</li></ul>'
      new Sortable(list())
